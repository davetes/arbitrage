...
# Realistic profit thresholds for actual arbitrage (after fees ~0.3%)
MIN_PROFIT_PCT = float(os.getenv("MIN_PROFIT_PCT", 0.05))  # 0.05% min net profit
MAX_PROFIT_PCT = float(os.getenv("MAX_PROFIT_PCT", 0.5))   # 0.5% max (higher is suspicious)
